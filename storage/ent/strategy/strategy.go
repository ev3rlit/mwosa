...
var (
	...
	// ActiveVersionIDValidator is a validator for the "active_version_id" field. It is called by the builders before save.
	ActiveVersionIDValidator func(string) error
