...
// function as DailyBar mutator.
type DailyBarFunc func(context.Context, *ent.DailyBarMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f DailyBarFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.DailyBarMutation); ok {
		return f(ctx, mv)
	}
