...
const (
	DefaultBaseURL      = "https://apis.data.go.kr/1160100/service/GetStockSecuritiesInfoService"
	DefaultNumOfRows    = 100
	DefaultAllNumOfRows = 1000

	ProviderDataGo             = "datago"
	GroupStockPrice            = "stockPrice"
	OperationGetStockPriceInfo = "getStockPriceInfo"
