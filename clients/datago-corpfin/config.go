...
const (
	DefaultBaseURL      = "https://apis.data.go.kr/1160100/service/GetFinaStatInfoService_V2"
	DefaultNumOfRows    = 100
	DefaultAllNumOfRows = 1000

	ProviderDataGo                = "datago"
	GroupCorporateFinance         = "corporateFinance"
	OperationGetSummFinaStatV2    = "getSummFinaStat_V2"
	OperationGetBalanceSheetV2    = "getBs_V2"
	OperationGetIncomeStatementV2 = "getIncoStat_V2"
